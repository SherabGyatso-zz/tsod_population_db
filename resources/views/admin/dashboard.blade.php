  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="{{ url('admin/view-profiles') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Profiles </a> </li>
        @endif
        
        @if(Session::get('adminDetails')['occupation_access']==1)
        <li class="bg_ls"> <a href="{{ url('admin/view-occupations') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Occupations </a> </li>
        @endif
        @if(Session::get('adminDetails')['sponsorship_access']==1)
        <li class="bg_lg"> <a href="{{ url('admin/view-sponsorships') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Sponsorships </a> </li>
        @endif
        @if(Session::get('adminDetails')['settlement_access']==1)
        <li class="bg_lr"> <a href="{{ url('admin/view-settlements') }}"> <i class="icon-inbox"></i><span class="label label-success">101</span> Settlements </a> </li>
        @endif
